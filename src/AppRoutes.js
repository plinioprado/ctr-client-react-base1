...
import Accounts from "./ledger1/components/accounts/Accounts";
import Account from "./ledger1/components/accounts/Account";
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/ledger/accounts/:num" element={<Account />} />
      <Route
        path="/report/chart_accounts"
        element={<Report name="chart_accounts" />}
      />
      <Route path="/report/journal" element={<Report name="journal" />} />
      <Route
        path="/report/general_ledger"
        element={<Report name="general_ledger" />}
      />
      <Route
        path="/report/trial_balance"
        element={<Report name="trial_balance" />}
      />
